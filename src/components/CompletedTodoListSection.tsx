    ...
    <>
      {Object.entries(groupedTodos).map(([date, todosForDate]) => (
        <div key={date}>
          ...
          <div className="flex h-64 w-52 flex-col overflow-x-auto whitespace-pre-wrap rounded-3xl border-none bg-gray-700 p-6">
            {todosForDate.map((todo) => (
              <div key={todo.id} className="mb-2 flex gap-2 text-nowrap">
